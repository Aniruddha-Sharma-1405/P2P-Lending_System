...
--
-- Host: localhost    Database: lender
-- ------------------------------------------------------
...
INSERT INTO `lusers` VALUES (1,'l1','l@gmail.com','abc');
...
INSERT INTO `busers` VALUES (1,'b1','b@gmail.com','abc');

/*!40000 ALTER TABLE `busers` ENABLE KEYS */;
UNLOCK TABLES;

DROP TABLE IF EXISTS `lenderm`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lenderm` (
    `id` int(10) NOT NULL AUTO_INCREMENT,
    `name` varchar(100) NOT NULL,
    `amountlend` int(10) NOT NULL,
    PRIMARY KEY (`id`)
)ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;

LOCK TABLES `lenderm` WRITE;
/*!40000 ALTER TABLE `lenderm` DISABLE KEYS */;
INSERT INTO `lenderm` VALUES (1,'b1',2700);

/*!40000 ALTER TABLE `lenderm` ENABLE KEYS */;
UNLOCK TABLES;
